...
<div class="avatar">
	<div class="avatar__img">
		<img src="img/avatar.jpg" alt="Личное фото">
		<a href="#" title="Удалить аватарку" class="avatar__delete"></a>
	</div>
	<div class="avatar__load">
		...
		<input id="avatar-img" type="file" name="photo">
	</div>
</div>
-->
...
<div class="avatar" style="width:100%">
		...
		<div class="avatar__load" style="margin: 7px auto;">
			...
			<button type="button">
				...
				<?php esc_html_e('Сменить аватарку', 'lege'); ?>
			</button>
			</a>
		</div>
	</div>
	<div class="edit" style="width: 100%">
		<a href="<?php echo wp_logout_url(home_url()); ?>" class="exit">
			...
			<?php esc_html_e('Выход', 'lege'); ?>
		</a>
		<span class="modal-сaution"><?php esc_html_e('Личные данные успешно изменены', 'lege'); ?></span>
...
<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide edit__group">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text edit__input" name="account_display_name" id="account_display_name" aria-describedby="account_display_name_description" value="<?php echo esc_attr( $user->display_name ); ?>" aria-required="true" /> <span id="account_display_name_description" class="modal-text"><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></em></span>
</div>
	...
	?>
			...
			<div class="edit__group">
				<label><?php esc_html_e('Телефон','lege'); ?></label>
	...
	<div class="edit__btn">
		...
		<input type="submit" id="save-edit" name="save_account_details" value="<?php esc_attr_e('Сохранить', 'lege'); ?>" class="btn edit__submit" />
