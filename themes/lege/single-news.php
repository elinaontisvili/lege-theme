		...
		<section class="single event">
			<div class="event-top" style="background: #fff url(<?php echo wp_get_attachment_url(get_post_thumbnail_id(get_the_ID())); ?>) no-repeat center top/ cover;">
				<div class="wrapper">
					...
					<ul class="tags-list">
						<?php $news_categories = wp_get_post_terms(get_the_ID(),'news-category'); // functions.php taxonomy
					...
					<div class="event__wrap">
						...
						<ul class="event__nav">
							<?php $prev_post = get_previous_post();
                                if (!empty( $prev_post )): ?>
                                    <li class="prev">
                                        <a href="<?php echo $prev_post->guid ?>"><?php esc_html_e('Предыдущая новость', 'lege'); ?></a>
                                    </li>
                                <?php endif; 
