...
if ( class_exists( 'WooCommerce' ) ) {
    ...
    add_action( 'after_setup_theme', 'lege_setup_woocommerce' );
    function lege_setup_woocommerce() {
        ...
        /* Enable Cart Fragments refresh for cart count (Ajax) */
        ...
        function lege_header_add_to_cart_fragment( $fragments ) {
            ...
            <a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="heading__bag">
                <svg width="17" height="20"><use xlink:href="#bag"/></svg>
        ...
        /* Карточка Продукта, Product Image Wrappers */
        ...
        /* Custom product data (Title, price, rating) */
        function lege_product_data(){
            ...
            <div class="products__detail">
                <a href="<?php the_permalink(); ?>" class="products__name">
                    <?php
                    $short_title = get_post_meta(get_the_ID(),'lege_short_title',true);
                    echo $short_title ? esc_html($short_title) : mb_substr( get_the_title(), 0, 17, 'UTF-8' );
                    ?>
                </a>
                <div class="price">
        ...
        /*--------------------------------------------------------------
        # Badges (Hot/New) on archive pages
        --------------------------------------------------------------*/
        ...
        /* Hide stock everywhere except variable products page and popup */
        ...
        /*--------------------------------------------------------------
        # Quick View - AJAX (Single product page popup modal window)
        --------------------------------------------------------------*/
        ...
        /*--------------------------------------------------------------
        # Registration Form (- )Add phone field to Woo registration form)
        --------------------------------------------------------------*/
